...
public class XLSXCovertCSVReader {
	 ...
	 * @param @param minColumns	excel行数
	 * @param @return
	 * @param @throws IOException
	 * @param @throws OpenXML4JException
	 * @param @throws ParserConfigurationException
	...
	public static List<String[]> readerExcel(InputStream inputStream, int minColumns) throws IOException, OpenXML4JException, ParserConfigurationException, SAXException{
	...
	public static void main(String[] args) throws IOException, OpenXML4JException, ParserConfigurationException, SAXException {
		//String path  = "C:\\Users\\keith\\AppData\\Local\\VcreditChatData\\MessageFile\\推荐码.xlsx";
		String path = "C:\\Users\\keith\\Desktop\\用户.xlsx";
		File file = new File(path);
		InputStream inputStream = new FileInputStream(file);
		List<String[]> list = readerExcel(inputStream, 10);
		print(list);
	}
